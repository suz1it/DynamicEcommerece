...
import { RegisterComponent } from './pages/auth-admin/register/register.component';
import { ForgotPasswordComponent } from './pages/auth-admin/forgot-password/forgot-password.component';
import { LockscreenComponent } from './pages/auth-admin/lockscreen/lockscreen.component';
